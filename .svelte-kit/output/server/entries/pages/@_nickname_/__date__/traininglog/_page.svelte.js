import { c as create_ssr_component, o as onDestroy, e as escape, b as each, a as add_attribute } from "../../../../../chunks/ssr.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container"><h3 class="svelte-hl29oo"><a data-sveltekit-reload href="${"/@" + escape(data.nickname, true) + "/"}">@${escape(data.nickname)} Food Porn</a> 
		...
		| <a data-sveltekit-reload href="${"/@" + escape(data.nickname, true) + "/foodlog"}">Food Log</a></h3></div>  <div class="trainingdaytabs"> ${each(data.trainingProgamDays.training_days, (day) => {
    return ` <button class="trainingdaytab svelte-hl29oo">${escape(day.day_description)}</button>`;
  })}</div>  <div style="display: flex; justify-content: center; align-items: center;"><div id="datagrid" class="ag-theme-alpine" style="height: 70vh; width: 100%;"${add_attribute("this", domNode, 0)}></div> </div>`;
});
export {
  Page as default
};
