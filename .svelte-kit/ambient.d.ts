...
declare module '$env/static/private' {
	...
	export const VITE_GITHUB_ID: string;
	export const VITE_GITHUB_SECRET: string;
	export const VITE_GOOGLE_ID: string;
	export const VITE_GOOGLE_SECRET: string;
	export const GPT3_API_KEY: string;
	export const GPT_4o_API_KEY: string;
	export const VITE_NEXTAUTH_UR: string;
	...
	export const VITE_TWITTER_ID: string;
	export const VITE_TWITTER_KEY: string;
	export const VITE_TWITTER_SECRET: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		VITE_TWITTER_ID: string;
		VITE_TWITTER_KEY: string;
		VITE_TWITTER_SECRET: string;
		TERM_PROGRAM: string;
		NODE: string;
		INIT_CWD: string;
		TERM: string;
