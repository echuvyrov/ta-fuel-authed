...
type LayoutRouteId = RouteId | "/" | "/@[nickname]/[[date]]" | "/@[nickname]/[[date]]/foodlog" | "/@[nickname]/[[date]]/traininglog" | "/about" | "/experience/[date]" | "/foodlog/[date]" | "/protected" | "/reference" | "/traininglog/[date]" | null
